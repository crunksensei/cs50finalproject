...
import { getSession, generateSecureToken, commitSession, validateCredentials, saveSessionToDatabase, validateSessionToken } from "../utils/session.server";
    ...
    <div className="max-w-md w-full space-y-8">
      ...
      <Form method="post" className="mt-8 space-y-6">
        ...
        <div>
          ...
          <Link to="/register">
          <button
            className="group relative w-full flex justify-center my-3 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-teal-500 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:bg-teal-500"
          >
            Register
          </button>
          </Link>
