  ...
  return (    
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-md px-4 md:px-8">
        ...
        <Link prefetch="intent" to="/account/username" className="text-2xl font-semibold">
        <button className="px-2 py-1 bg-teal-500 text-white text-sm md:px-4 md:py-2 md:text-base rounded-lg">
            Update Username
          </button>
        </Link>
        <Link prefetch="intent" to="/account/password" className="text-2xl font-semibold">
        <button className="px-2 py-1 bg-teal-500 text-white text-sm md:px-4 md:py-2 md:text-base rounded-lg">
            Update Password
          </button>
        </Link>
        <Link prefetch="intent" to="/account" className="text-2xl font-semibold">
        <button className="px-2 py-1 bg-teal-500 text-white text-sm md:px-4 md:py-2 md:text-base rounded-lg">
            Reviewed Games
          </button>
        </Link>
